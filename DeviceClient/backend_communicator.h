...
NetworkMetrics: метрики сети (например, {"type": "NetworkMetrics", "bandwidth": 100.5, "latency": 12.3, "packet_loss":
0.01}) DeviceStatus: статус устройства (например, {"type": "DeviceStatus", "uptime": 3600, "cpu_usage": 25,
"memory_usage": 60}).
