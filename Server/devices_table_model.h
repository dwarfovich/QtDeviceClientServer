...
public:
    ...
    int rowCount(const QModelIndex& parent = {}) const override { return devices_.size(); }
    int columnCount(const QModelIndex& parent = {}) const override { return static_cast<int>(Columns::ColumnsCount); }
    QVariant data(const QModelIndex& index, int role = Qt::DisplayRole) const override
    {
        ...
        switch (index.column()) {
            case static_cast<int>(Columns::Id): return device.id;
            case static_cast<int>(Columns::Address): return device.address.toString();
